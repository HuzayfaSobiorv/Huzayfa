...
# 2026-07-10: Хитой "克力木" (буюртма-остатка) форматида дукерсиз
# (Бесшовный) қувурлар spec ичида алоҳида белги билан келмайди (бошқа
# файл-форматдаги "无缝管" каби). Шу сабаб диаметр+стенка+марка
# комбинацияси асосида ANIQ жадвал ишлатилади. Текширилган
# (Min_Zaxira.xlsx + жорий Инвентар, 2026-07-10): ҳар бир комбинация
# учун ОДДИЙ (Бесшовныйсиз) дупликат МАВЖУД ЭМАС — демак ноаниқлик йўқ.
BESHOVNY_KOMBO = {
    ("25", "3,0", "304"), ("32", "3,0", "304"),
    ("38", "3,0", "304"), ("38", "3,5", "304"),
    ("42", "3,0", "304"), ("51", "3,0", "304"),
    ("63", "3,0", "304"), ("76", "3,0", "304"),
    ("89", "3,0", "304"), ("102", "3,0", "304"),
    ("108", "3,5", "304"), ("127", "3,0", "304"),
    ("127", "3,5", "304"), ("133", "4,0", "304"),
    ("159", "3,0", "304"), ("159", "3,5", "304"),
}
