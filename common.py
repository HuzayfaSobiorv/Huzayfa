...
FILIAL_GURUHLARI: dict[str, list[str]] = {
    ...
    # 2026-07-24 (Huzayfa): Тошкент, Оптом Тошкент, 37 Склад ro'yxatdan
    # OLIB TASHLANDI — kuzatilmaydigan yo'nalishlar. Ularning xom ustunlari
    # endi _YANGI_FORMAT_SKIP_KALIT'ga qo'shildi ('тошкент', '37 склад'),
    # shuning uchun _lokatsiya_kanali() ular uchun None qaytaradi — na
    # filial sifatida ko'rsatiladi, na Асосий_Қолдиқ (buyurtma) hisobiga
    # kiradi.
